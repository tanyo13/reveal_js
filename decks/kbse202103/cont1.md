...
* 問題
    * 入力で与えられる配列 a (要素は整数，長さは10) の要素のうち，
	  正の数を数えて，
	  変数 count に格納せよ．
...
* 検証できる内容
  * 任意の入力に対し，正解プログラムと同一の出力を与えること．
  * 一定の方法 (Presburger論理式) で表現できる性質を満たすこと．
...
|---|---|---|---|
| テキスト | プログラムをいちから書かせる． | ○ | ○ |
| 短冊 <span style="color: white;">abcdefghij</span> | プログラムを構成する行「短冊」を選択肢として与える．受験者は，選択肢を並べ替えてプログラムを作成する．| ○ | ○ |
| ブロック | ブロックを組み合わせてプログラムを作成させる．| ○ | × |
| 穴埋め | 穴の空いたプログラムを提示し，書き込ませたり，選択肢から選ばせる．| ○ | ○ |

<p style="margin: 60pt;"></p>
...
<img src="tanzaku_ans_1.jpg">

---

## 短冊型解答例

<img src="tanzaku_ans_2.jpg">
...
* assume 文と assert 文が書ける．
  * assume 文: 「この条件にしか興味が無い」
  * assert 文: 「この条件が成り立つ」
  * Presburger 算術の式が，条件として指定できる．
